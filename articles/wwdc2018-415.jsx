...
// (WWDC18 session 415). Text and diagrams only — the generic
// renderer in article.jsx owns all presentation.
// ————————————————————————————————————————————————
...
export default {
  id: "wwdc2018-415",
  breadcrumb: "wwdc2018-415.article",
  eyebrow: "WWDC18 · Session 415 · full write-up from the transcript",
  ...
  lede: (
    <>
      ...
      the point. <A href="https://developer.apple.com/videos/play/wwdc2018/415/">Watch the session</A> if you'd rather have the 55-minute
      version. And if headers, symbols and static libraries are hazy, start with <PageLink href="#/toolchain-primer">the primer</PageLink> and
      come back.
    </>
  ),
  blocks: [
    // ————— 01 · Build system —————
    { type: "kicker", text: "01 · Jake Petroules · Xcode build system team" },
    { type: "h2", text: "What happens when you press ⌘B" },
    {
      type: "p",
      content: (
        <>
    ...
    { type: "figure", render: BuildGraphFigure },
    { type: "h3", text: "Incremental builds are just hashes" },
    {
      type: "p",
      content: (
        <>
    ...
    { type: "h3", text: "Where dependencies come from" },
    {
      type: "p",
      content: (
        <>
    ...
    },
    {
      type: "callout",
      color: T.red,
      label: "auto-link won't save you",
      content: (
        <>
    ...
    // ————— 02 · Clang —————
    { type: "kicker", text: "02 · Jurgen · Clang frontend team" },
    { type: "h2", text: "Headers, headermaps and the nine-megabyte include" },
    {
      type: "p",
      content: (
        <>
    ...
    },
    {
      type: "callout",
      color: T.yellow,
      label: "two classic headermap surprises",
      content: (
        <>
    ...
    { type: "h3", text: "Finding system headers" },
    {
      type: "p",
      content: (
        <>
    ...
    { type: "h3", text: "The problem modules solve" },
    {
      type: "p",
      content: (
        <>
    ...
    { type: "figure", render: ModuleCacheFigure },
    {
      type: "p",
      content: (
        <>
    ...
    {
      type: "code",
      title: "module.modulemap — Foundation's, roughly",
      code: `framework module Foundation {
  ...
  export *
    ...
    // ————— 03 · Swift —————
    { type: "kicker", text: "03 · Devin · Swift compiler" },
    { type: "h2", text: "How Swift finds declarations without headers" },
    {
      type: "p",
      content: (
        <>
    ...
    { type: "h3", text: "Importing Objective-C into Swift" },
    {
      type: "p",
      content: (
        <>
    ...
    { type: "h3", text: "Importing Swift into Objective-C" },
    {
      type: "p",
      content: (
        <>
    ...
    { type: "figure", render: InteropFigure },
    { type: "h3", text: "Swift modules" },
    {
      type: "p",
      content: (
        <>
    ...
    // ————— 04 · Linker —————
    { type: "kicker", text: "04 · Louis Gerbarg · linker" },
    { type: "h2", text: "The linker moves and patches — it never creates" },
    {
      type: "p",
      content: (
        <>
...
playSound(char const*)`,
    ...
    { type: "h3", text: "What the linker eats" },
    {
      type: "list",
      items: [
    ...
    },
    {
      type: "callout",
      color: T.yellow,
      label: "static archives load selectively",
      content: (
        <>
    ...
    { type: "h3", text: "Worked example: linking PetKit" },
    {
      type: "p",
      content: (
        <>
    ...
    {
      type: "code",
      title: "cat.o — simplified arm64",
      code: `        .section  __TEXT,__cstring
...
"-[Cat purr]":
        ...
        bl        __Z9playSoundPKc     ; the arm64 worst case`,
    },
    {
      type: "p",
      content: (
    ...
    { type: "figure", render: LinkerFigure },

    // ————— Wrap-up —————
    { type: "kicker", text: "wrap-up" },
    { type: "h2", text: "The homework" },
    {
      type: "p",
      content: (
        <>
